...
document.addEventListener('DOMContentLoaded', () => {
  // 1. Check if they are truly logged in OR in Demo Mode
  const isGuestDemo = sessionStorage.getItem('isDemoMode') === 'true';
  const isLoggedIn = Auth.isLoggedIn();

  // 2. ONLY redirect to dashboard if they have a real account.
  // We don't redirect Guest Demo users here because they might 
  // actually want to sign up to save their data!
  if (isLoggedIn) {
